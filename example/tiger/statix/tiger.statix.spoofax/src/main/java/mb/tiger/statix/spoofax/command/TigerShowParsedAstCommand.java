...
public class TigerShowParsedAstCommand implements CommandDef<mb.tiger.statix.spoofax.task.TigerShowArgs> {
    private final mb.tiger.statix.spoofax.task.TigerShowParsedAst tigerShowParsedAst;


    @Inject public TigerShowParsedAstCommand(mb.tiger.statix.spoofax.task.TigerShowParsedAst tigerShowParsedAst) {
