 ...
 */
public final class TigerUpgradePlaceholders extends StrategoTaskDefBase<TigerUpgradePlaceholders.Input, @Nullable IStrategoTerm> {
    ...
    @Inject public TigerUpgradePlaceholders(
    ...
    @Override public @Nullable IStrategoTerm exec(ExecContext context, Input input) throws Exception {
        return callStrategy("upgrade-placeholders-Tiger", input.termSupplier.get(context));
    }
}
