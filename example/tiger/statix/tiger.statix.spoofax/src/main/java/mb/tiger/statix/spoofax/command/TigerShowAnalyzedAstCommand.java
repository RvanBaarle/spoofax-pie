...
public class TigerShowAnalyzedAstCommand implements CommandDef<mb.tiger.statix.spoofax.task.TigerShowArgs> {
    private final mb.tiger.statix.spoofax.task.TigerShowAnalyzedAst tigerShowAnalyzedAst;


    @Inject public TigerShowAnalyzedAstCommand(mb.tiger.statix.spoofax.task.TigerShowAnalyzedAst tigerShowAnalyzedAst) {
