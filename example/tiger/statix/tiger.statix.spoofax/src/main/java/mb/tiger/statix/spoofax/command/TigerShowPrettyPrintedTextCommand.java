...
public class TigerShowPrettyPrintedTextCommand implements CommandDef<mb.tiger.statix.spoofax.task.TigerShowArgs> {
    private final mb.tiger.statix.spoofax.task.TigerShowPrettyPrintedText tigerShowPrettyPrintedText;


    @Inject public TigerShowPrettyPrintedTextCommand(mb.tiger.statix.spoofax.task.TigerShowPrettyPrintedText tigerShowPrettyPrintedText) {
