...
public class TigerClassLoaderResources {
    public final ClassLoaderResourceRegistry resourceRegistry = new ClassLoaderResourceRegistry("mb-tiger-statix-classloader-resource", TigerClassLoaderResources.class.getClassLoader());
    ...
    public final ClassLoaderResource definitionDirectory = resourceRegistry.getResource("mb/tiger/statix");
