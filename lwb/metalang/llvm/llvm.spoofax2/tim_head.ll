...
@.int_fmt = private unnamed_addr constant [4 x i8] c"%ld\00"
...
; tim runtime library
declare ptr addrspace(1) @record_new(i64, i1) nounwind
...
declare ptr addrspace(1) @gc_alloc(i64, i1) nounwind inaccessiblememonly allockind("alloc,uninitialized") allocsize(0) "alloc-family"="malloc"
