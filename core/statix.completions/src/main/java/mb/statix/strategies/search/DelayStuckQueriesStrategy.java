 ...
 */
public final class DelayStuckQueriesStrategy implements SearchStrategy {
    ...
    private Optional<Delay> checkDelay(Spec spec, CResolveQuery query, IState.Immutable state,
        ...
        // @formatter:off
        final mb.statix.generator.scopegraph.NameResolution<Scope, ITerm, ITerm, CEqual> nameResolution = new NameResolution<>(
            spec,
            state.scopeGraph(),
            labelWF, labelOrd,
