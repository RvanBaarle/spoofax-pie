...
public class TigerCompletenessTest extends CompletenessTest {
    ...
    public List<DynamicTest> completenessTests() {
        return Arrays.asList(
            ...
            tigerTest("/xmpl/queens.tig"),        // interrupted
            tigerTest("/xmpl/rec1.tig"),          // interrupted
            tigerTest("/xmpl/record.tig"),        // interrupted
            tigerTest("/xmpl/renaming1.tig"),     // interrupted
            tigerTest("/xmpl/seq.tig"),           // interrupted
            tigerTest("/xmpl/trtest1.tig"),       // interrupted
            tigerTest("/xmpl/trtest2.tig"),       // interrupted
            tigerTest("/xmpl/trtest3.tig"),       // interrupted
            tigerTest("/xmpl/trtest4.tig"),       // interrupted
            tigerTest("/xmpl/typecheck-error1.tig"),       // interrupted
